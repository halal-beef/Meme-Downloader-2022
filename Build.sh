...
dotnet publish "/home/runner/work/Meme-Downloader-2022/Meme-Downloader-2022/Meme Downloader 2022.csproj" --output "build\\" --arch x64 --os win -c release --self-contained true # win build

dotnet publish "/home/runner/work/Meme-Downloader-2022/Meme-Downloader-2022/Meme Downloader 2022.csproj" --output "build-debug\\" --arch x64 --os win -c debug --self-contained true # win build
...
dotnet publish "/home/runner/work/Meme-Downloader-2022/Meme-Downloader-2022/Meme Downloader 2022.csproj" --output "build-debug\\" --arch x64 --os linux -c debug --self-contained true # linux build
